...
translate schinese strings:
    ...
    new "剪贴板朗读已启用。按‘Shift+C’以禁用。"

    # renpy/common/00preferences.rpy:618
    old "Self-voicing would say \"[renpy.display.tts.last]\". Press 'alt+shift+V' to disable."
    new "机器朗读会朗读“[renpy.display.tts.last]”。按‘Alt+Shift+V’以禁用。"
    ...
    new "复制追溯报告（traceback.txt）的内容到剪贴板并转换为BBcode以供诸如 https://lemmasoft.renai.us/ 等论坛使用。"
    ...
    new "复制追溯报告（traceback.txt）的内容到剪贴板并转换为Markdown以供Discord使用。"
